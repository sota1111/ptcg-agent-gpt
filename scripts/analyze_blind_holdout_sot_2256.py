"""Deterministically summarize the SOT-2256 blind holdout reports."""
...
def main() -> int:
    ...
    report_dir = root / "artifacts" / "sot-2256" / "holdout"
    reports = {
    ...
    result = {
        ...
        "decision": {
            ...
            "operational_audit_passed": all(
                report["faults_semantic"] == 0 and report["unfinished"] == 0
                for report in reports.values()
            ),
            "reason": "SOT-2255 promoted no candidate; blind holdout audits the retained champion",
        },
    }
